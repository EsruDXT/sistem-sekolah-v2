...
@section('title', $title ?? 'Sistem Sekolah - Detail Kelas')
...
@section('content')
    ...
    <div class="mt-3 border border-[#E5E3DB] bg-white">
        ...
        <div class="flex items-start justify-between border-b border-[#E5E3DB] bg-[#FCFBF8] px-8 py-6">
            ...
            <a href="{{ route('classes.edit', ['id' => $class['id'] ?? 1]) }}"
        ...
        <dl class="divide-y divide-[#EFEDE6] text-sm">
            ...
            <div class="flex justify-between px-8 py-4">
                ...
                <dd class="font-medium text-[#16213A]">{{ $class['major'] ?? $class['major_name'] ?? '' }}</dd>
            ...
            <div class="flex justify-between px-8 py-4">
                ...
                <dd class="font-medium text-[#16213A]">{{ $class['homeroom_teacher'] ?? $class['teacher_name'] ?? '' }}</dd>
        ...
        <div class="flex justify-end gap-4 border-t border-[#E5E3DB] px-8 py-5">
            ...
            <form action="{{ route('classes.destroy', ['id' => $class['id'] ?? 1]) }}" method="POST" onsubmit="return confirm('Hapus data kelas ini dari buku induk?')">
